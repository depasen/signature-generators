...
/* ------------------------------------------------------------------ *
 * IntraBalance email-signature generator
 *
 * Teammates fill in five personal fields; everything else (logo, peach
 * pattern, brand colors, company name, website, social links) is shared
 * and stays identical to ib-signature/signature.html.
 *
...
const CDN = "https://cdn.jsdelivr.net/gh/depasen/ib-brand-assets@main"
const DEFAULT_HEADSHOT = `${CDN}/ib-sandeep-headshot.jpg`
...
const DEFAULTS: Fields = {
  ...
  email: "sandeep@intrabalance.com",
  phone: "(415) 941-8110",
...
/* Per-variant colors + asset names. Social icons (ib-social-*.png) are shared. */
const THEMES: Record<
  Variant,
  {
...
> = {
  dark: {
    tableStyleExtra: "background-color:#1c4e78;",
    ring: "rgba(43,179,173,0.55)",
    name: "#f4f9fa",
    title: "#9fd9d5",
    accent: "#f0c0a0",
    company: "#5fd0ca",
    ...
    iconSuffix: "-peach",
    socialSuffix: "",
    mark: "ib-mark-peach.png",
    pattern: "ib-pattern-cell.png",
    markFill: "#184878",
    markBorder: "#2d5f8a",
  },
  light: {
    tableStyleExtra: "background-color:#e9f2f6;border:1px solid #cadde7;",
    ring: "rgba(43,179,173,0.45)",
    name: "#12395c",
    title: "#5a7f95",
    accent: "#1a9b95",
    company: "#1a9b95",
    ...
    iconSuffix: "-navy",
    socialSuffix: "-navy",
    mark: "ib-mark-navy.png",
    pattern: "ib-pattern-cell-light.png",
    markFill: "#dbe9f0",
    markBorder: "#cadde7",
  },
}
...
function buildSignature(f: Fields, variant: Variant = "dark"): string {
  ...
  const phoneBlock = phone
    ? `<a href="tel:${tel}" target="_blank" style="text-decoration:none;color:${t.contact};white-space:nowrap;"><img src="${CDN}/ib-ic-phone${t.iconSuffix}.png" width="13" height="13" alt="Phone" style="width:13px;height:13px;border:0;outline:none;vertical-align:-2px;">&nbsp;&nbsp;<span style="color:${t.contact};">${phoneEsc}</span></a>&nbsp;&nbsp;&nbsp;<span style="color:${t.sep};" aria-hidden="true">|</span>&nbsp;&nbsp;&nbsp;`
    : ""

  // Right cell uses the woven pattern + VML fallback in both variants; the tile
  // and panel fill differ per theme.
  const markCell = `<td class="ibh-mark-cell" width="96" bgcolor="${t.markFill}" background="${CDN}/${t.pattern}" style="width:96px;vertical-align:middle;text-align:center;padding:16px 18px 16px 0;border-left:1px solid ${t.markBorder};background-color:${t.markFill};background-image:url('${CDN}/${t.pattern}');background-position:center center;background-repeat:repeat;">
          <!--[if gte mso 9]>
          ...
          <a href="https://intrabalance.com/" target="_blank" style="display:inline-block;border:0;outline:none;">
            <img src="${CDN}/${t.mark}"
                 width="43" height="58" alt="IntraBalance"
                 style="width:43px;height:58px;display:inline-block;border:0;outline:none;">
          </a>
          <div style="font-size:0;line-height:0;height:9px;">&nbsp;</div>
          <div style="font-size:0;line-height:0;"><a href="https://www.youtube.com/@IntraBalance" target="_blank" style="display:inline-block;"><img width="16" height="16" alt="YouTube" src="${CDN}/ib-social-youtube${t.socialSuffix}.png" style="width:16px;height:16px;border:0;outline:none;display:inline-block;"></a><a href="https://www.instagram.com/intrabalance/" target="_blank" style="display:inline-block;margin-left:12px;"><img width="16" height="16" alt="Instagram" src="${CDN}/ib-social-instagram${t.socialSuffix}.png" style="width:16px;height:16px;border:0;outline:none;display:inline-block;"></a><a href="https://www.facebook.com/IntraBalanceLLC/" target="_blank" style="display:inline-block;margin-left:12px;"><img width="16" height="16" alt="Facebook" src="${CDN}/ib-social-facebook${t.socialSuffix}.png" style="width:16px;height:16px;border:0;outline:none;display:inline-block;"></a></div>
...
<style>
  ...
  .ibh-sig a { text-decoration: none; }
  ...
  @media only screen and (max-width: 480px) {
    .ibh-mark-cell { display: none !important; }
  }
</style>

<div dir="auto"><div dir="ltr" class="ibh-sig">
    ...
    <tbody>
      <tr>
        ...
        <td width="90" style="width:90px;vertical-align:middle;text-align:center;padding:16px 0 16px 18px;">
          <a href="https://intrabalance.com/" target="_blank" style="display:inline-block;border:0;outline:none;text-decoration:none;">
            <img src="${headshot}"
        ...
        <td style="vertical-align:middle;padding:16px 18px;">
          ...
          <div style="line-height:1.35;">
            <span style="font-family:'Newsreader',Georgia,serif;font-size:12.5px;font-weight:600;color:${t.company};letter-spacing:.01em;">IntraBalance LLC</span>
          </div>
          <div style="line-height:1.4;padding-top:1px;">
            <span style="font-size:10.5px;color:${t.tagline};">Sleep Education for Clinicians</span>
          </div>

          <div style="line-height:1.7;font-size:11px;color:${t.contact};padding-top:8px;">
            ${phoneBlock}<a href="https://intrabalance.com/" target="_blank" style="text-decoration:none;color:${t.contact};white-space:nowrap;"><img src="${CDN}/ib-ic-web${t.iconSuffix}.png" width="13" height="13" alt="Website" style="width:13px;height:13px;border:0;outline:none;vertical-align:-2px;">&nbsp;&nbsp;<span style="color:${t.contact};">intrabalance.com</span></a><br>
            <a href="mailto:${email}" target="_blank" style="text-decoration:none;color:${t.contact};white-space:nowrap;"><img src="${CDN}/ib-ic-email${t.iconSuffix}.png" width="13" height="13" alt="Email" style="width:13px;height:13px;border:0;outline:none;vertical-align:-2px;">&nbsp;&nbsp;<span style="color:${t.contact};">${emailEsc}</span></a>
          </div>
        </td>
...
export default function IbSignatureGeneratorPage() {
...
(function(){
  ...
  function downloadHtml() {
    ...
    a.href = url
    a.download = `ib-signature-${safe}.html`
    ...
    <main className="min-h-screen bg-porcelain">
      <div className="mx-auto max-w-6xl px-5 py-10 md:py-14">
        <header className="max-w-2xl">
          <p className="pip-eyebrow text-copper">IntraBalance</p>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-2">
          ...
          <section aria-label="Your details" className="rounded-lg border border-hairline bg-white p-6 shadow-brand-sm">
            ...
            <div className="mt-5 grid gap-5">
                ...
                <div className="mt-2 grid grid-cols-2 gap-3">
                  {(
                    [
                      ...
                      { key: "light", label: "Light", desc: "Soft blue card" },
              ...
              <Field
                ...
                value={fields.title}
                onChange={set("title")}
                placeholder="Sleep Medicine Educator"
              />
              <Field
                label="Email"
                type="email"
                value={fields.email}
                onChange={set("email")}
                placeholder="jane@intrabalance.com"
              />
              <Field
                label="Phone"
              ...
              />
              {/* Headshot: auto-uploads and fills the URL for you. */}
              <div className="block">
          ...
          <section aria-label="Live preview" className="rounded-lg border border-hairline bg-white p-6 shadow-brand-sm">
            ...
            <p className="mt-4 text-xs leading-relaxed text-muted">
              This is the actual size your signature appears in email. The card carries its own{" "}
              {variant === "dark" ? "navy" : "soft blue"} background, so it looks identical on light or dark email
              themes. On a narrow screen you can scroll the preview sideways.
            </p>
          </section>
        </div>
